...
export class ExportService {
  ...
  private buildRecord(p: ProductDocument) {
    ...
    return {
      ...
      company: {
        ...
        years_established: s.yearsEstablished ?? null,
        number_of_employees: s.numberOfEmployees ?? '',
        turnover: s.turnover ?? '',
  ...
  private static readonly FLAT_COLUMNS = [
    ...
    'seller.name', 'seller.address', 'seller.state', 'seller.country',
    'seller.contact_details', 'seller.logo_url',
    'company.gst_number', 'company.business_type', 'company.years_established',
    'company.number_of_employees', 'company.turnover', 'company.legal_status',
    'images',
